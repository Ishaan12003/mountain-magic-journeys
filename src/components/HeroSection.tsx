    ...
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col justify-center items-center text-white px-6">
        <div className={cn(
          ...
          scrolled ? "opacity-0 translate-y-[-30px]" : "opacity-100 translate-y-0"
        )}>
        ...
        {/* Scroll Indicator */}
        <div className={cn(
          "absolute bottom-12 left-1/2 transform -translate-x-1/2 h-24 transition-opacity duration-500",
